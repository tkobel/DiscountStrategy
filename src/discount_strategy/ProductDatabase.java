...
public class ProductDatabase {
    Product[] productDatabase = {
        ...
        new Product("AVN-803", "Blue Bath Towel", 8.49, new QtyDiscount(3,20)),
        new Product("KLA-024", "Chaps Necktie", 18.99, new BOGODiscount()),
        new Product("IOD-798", "Mr Coffeemaker", 38.99, new PercentDiscount(.15)),
        new Product("LDK-354", "Tweed Socks", 12.55, new QtyDiscount(2,22)),
        ...
        new Product("JDE-493", "Maple Coaster", 4.99, new QtyDiscount(4,17.49)),
